      ...
      child: Consumer<QuizProvider>(builder: (context, provider, _) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            elevation: 0,
            title: Text("Level  ${provider.currentQuestionLevel + 1}"),
            centerTitle: true,
            actions: [
              Padding(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      easyQuestions['questions'][provider.currentQuestionLevel]
                            ...
                            return InkWell(
                              onTap: () {
                                if (provider.buttonClicked == false) {
                                  ...
                                  if (easyQuestions['questions'][
                                                  provider.currentQuestionLevel]
                                              [provider.currentQuestion]
                                          ['correctAnswer'] ==
                                      index + 1) {
                                    //for taking correct answer fro color changing
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: provider.defalultButtonColorList[index]
                                      [0],
                                ),
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      color: provider
                                          .defalultButtonColorList[index][1],
                                    ),
                                  ),
                                ),
                              ),
